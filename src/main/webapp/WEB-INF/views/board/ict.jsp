...
<style>
    .card-img-top img {
        ...
        max-width: 100%; /* 이미지가 부모 요소보다 클 때만 크기 조정 */
        max-height: 300px; /* 이미지가 높이가 300px를 넘지 않도록 설정 */
    }
</style>
					    ...
					    <div class="col-lg-4 col-md-6 mb-4">
					        <div class="card h-100">
					            ...
					            <div class="card-img-top">
					                <c:choose>
					                    <c:when test="${not empty ict.attachListt}">
					                        <c:choose>
					                            <c:when test="${ict.attachListt[0].fileType ne 'txt'}">
					                                <img class="card-img-top" src="${ctxPath}/file/display?fileName=${ict.attachListt[0].uploadPath}/${ict.attachListt[0].uuid}_${ict.attachListt[0].fileName}" alt="이미지">
					                            </c:when>
					                            <c:otherwise>
					                                <img class="card-img-top" src="${ctxPath}/resources/images/notextfile.jpg" alt="텍스트파일">
					                            </c:otherwise>
					                        </c:choose>
					                    </c:when>
					                    <c:otherwise>
					                        <img class="card-img-top" src="${ctxPath}/resources/images/noimage.jpg" alt="이미지없음">
					                    </c:otherwise>
					                </c:choose>
					            </div>
					            <div class="card-body">
